...
export default function RoomDetails({ id }: Props) {
  ...
  const checkIn = searchParams.get("checkIn") || getLocalDate(today);

  const checkOut = searchParams.get("checkOut") || getLocalDate(tomorrow);
  ...
  return (
    <>
        ...
        <section className="max-w-7xl mx-auto px-6 lg:px-10 mt-20">
          <div className="grid lg:grid-cols-3 gap-14">
            ...
            <div className="lg:col-span-2">
              <span className="gold-divider">Room Overview</span>
              ...
              <div className="grid md:grid-cols-3 gap-6 mt-10">
                <div className="bg-white rounded-3xl p-6 shadow-soft">
                  ...
                  <h4 className="font-semibold">{room.maxAdults} Adults</h4>
                </div>

                <div className="bg-white rounded-3xl p-6 shadow-soft">
                  <BedDouble className="text-gold mb-4" size={28} />
                  <h4 className="font-semibold">{room.bedType}</h4>
                </div>

                <div className="bg-white rounded-3xl p-6 shadow-soft">
                  <Maximize className="text-gold mb-4" size={28} />
                  <h4 className="font-semibold">{room.roomSize} m²</h4>
                </div>
              </div>

              {/* Amenities */}
              <div className="mt-20">
                <span className="gold-divider">Amenities</span>
              ...
              {/* Room Information */}
              <div className="mt-20">
                <span className="gold-divider">Details</span>
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <span className="text-textmuted ">/ per night</span>
                    </div>
                  </div>
      ...
      <RelatedRooms currentRoomId={room._id} />
      {showBookingModal && (
        <div
          className="
      fixed
    ...
    "
      ...
      "
          >
            ...
            <div className="space-y-4">
              <SummaryRow label="Room" value={room.roomName} />

              <SummaryRow label="Room Type" value={room.roomType} />
              ...
              <SummaryRow label="Nights" value={String(totalNights)} />
...
function Info({ label, value }: { label: string; value: string | number }) {
  return (
    <div className="bg-white rounded-3xl p-6 shadow-soft">
      ...
      <p className="mt-2 font-semibold text-lg text-maroon">{value}</p>
    </div>
  );
}
...
function SummaryRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex justify-between">
      ...
      <span className="font-playfair text-right">{value}</span>
    </div>
  );
}
