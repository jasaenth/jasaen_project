...
return ( <footer className="bg-charcoal text-ivory/80"> <div className="mx-auto max-w-7xl px-6 lg:px-10 py-20 grid gap-12 lg:grid-cols-4">
{/* Brand */} <div> <Image
         src="/logowhite.png"
         alt="Jasaen Hotel"
         width={140}
    ...
    {/* Explore */}
    <div>
      <h4 className="font-display text-gold text-lg mb-5">
        Explore
      </h4>
