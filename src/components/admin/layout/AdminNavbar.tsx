...
const AdminNavbar = ({ onMenuClick, isMobileMenuOpen }: AdminNavbarProps) => {
  ...
  return (
    <>
      <header className="sticky top-0 z-30 bg-[#F7F4EF] border-b border-[#E5DDD0]">
...
"
                >
                  <Bell className="w-5 h-5 text-[#7A1024]" />
                  {unreadCount > 0 && (
                  ...
                  <div className="absolute right-0 mt-2 w-95 bg-white rounded-4xl shadow-xl border border-gray-200  overflow-hidden z-50">
                    ...
                    <div className="max-h-80 overflow-y-auto">
                      {notifications.map((notif) => (
                        <div
                          key={notif.id}
                          className={`p-4 border-b border-gray-100  hover:bg-secondary/50 transition cursor-pointer}`}
                        >
