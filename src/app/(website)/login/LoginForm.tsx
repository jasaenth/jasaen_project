...
export default function LoginForm() {
   ...
   *
   * If redirect is missing or invalid,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
       ...
       * return the user to the page they
  ...
  const handleGoogleLogin = async (credential: string) => {
    try {
       ...
       * IMPORTANT:
       *
       * Google login also returns the user
       * to the original booking/room page.
       */
